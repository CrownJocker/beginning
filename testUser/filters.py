...
class InstructionFilter(django_filters.FilterSet):
    name = django_filters.CharFilter(lookup_expr='icontains', label='Instruction name')
    filial = django_filters.ModelChoiceFilter(queryset=Filial.objects.all(), label='Filial')
